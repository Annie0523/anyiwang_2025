...
<body>
    ...
    <p class="medium-text">- 🏯2007.5.23 born in China → 
        👨‍👩‍👧‍👦2014.7.14 get a new home member, my brother born → 
        ✈️2022.11 move to the U.S. with my family✈️</p>
...
<head>
    ...
    <style>
        ...
        .food-image {
            height: 300px; /* Set consistent height for images */
...
<script>
        function MusicTaste() {
            ...
            window.location.href = "http://127.0.0.1:4100/Anyi_2025/music/"; // Replace this with the desired URL
        }

        // JavaScript function to show images and introduction about the hometown
        function showMyHometown() {
            ...
            // Create a new heading for the introduction
            var heading = document.createElement('h2');
            heading.textContent = "My Hometown🏠";

            // Create paragraphs for the introduction text
            var introText1 = document.createElement('p');
            introText1.textContent = "I am from Beijing, China.";
            introText1.style.fontSize = "20px"; // Set font size
            ...
            introText2.style.fontSize = "20px"; // Set font size
            ...
            introText3.style.fontSize = "20px"; // Set font size
